      ...
      <Wrapper className={cx("Wrapper-content")}>
        ...
        <div className={cx("main")}>
          ...
          <div className={cx("item")}>
            ...
            <div className={cx("input")}>
              <div className={cx('box-icon')}><FontAwesomeIcon className={cx("email-icon",'icon')} icon={faEnvelope} /></div>
              <input
                className={cx("input-content")}
          ...
          <div className={cx("item")}>
            ...
            <div className={cx("input")}>
              <div className={cx('box-icon')}><FontAwesomeIcon className={cx("icon-phone",'icon')} icon={faPhone} /></div>
        ...
        <div className={cx("footer")}>
          ...
          <div className={cx("sex")}>
            ...
            <div className={cx("select-sex")}>
              <div className={cx("s-sex-content")}>Nam</div>
              <div className={cx("s-sex-icon")}>
                <FontAwesomeIcon className={cx('icon-sex')} icon={faCaretDown} />
              </div>
            </div>
          </div>
        </div>
